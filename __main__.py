...
for dep_manifest in manifests_set:
    for root_manifest in manifests_set:
        ...
        if get_value(dep_manifest, 'dependencies') and get_value(root_manifest, 'resource_name') and get_value(dep_manifest, 'dependencies') in get_value(root_manifest, 'resource_name'):
            print('MATCHED')
